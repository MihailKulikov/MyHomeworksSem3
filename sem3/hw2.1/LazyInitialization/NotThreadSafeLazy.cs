...
namespace LazyInitialization
{
    ...
    public class NotThreadSafeLazy<T> : ILazy<T>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NotThreadSafeLazy{T}"/> class. When lazy initialization occurs, the specified initialization function is used.
        /// </summary>
        ...
        public NotThreadSafeLazy(Func<T> supplier)
        {
            this.supplier = supplier ?? throw new ArgumentNullException(nameof(supplier));
        }
        
        /// <summary>
        /// Gets the lazily initialized value of the current <see cref="NotThreadSafeLazy{T}"/> instance.
        /// </summary>
        /// <returns>The lazily initialized value of the current <see cref="NotThreadSafeLazy{T}"/> instance.</returns>
